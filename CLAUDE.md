...
- Current API generation: v2.x Fiber v3 migration (the `admin` surface exposes `fiber.Ctx` from `github.com/gofiber/fiber/v3`; observability types come from `lib-observability/v2`)
