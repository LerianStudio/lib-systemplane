...
LIB_SYSTEMPLANE := $(dir $(abspath $(lastword $(MAKEFILE_LIST))))

# Include shared color definitions and utility functions
include $(LIB_SYSTEMPLANE)/shell/makefile_colors.mk
include $(LIB_SYSTEMPLANE)/shell/makefile_utils.mk
...
# Supports PKG parameter to filter packages (e.g., PKG=./internal/postgres/...)
