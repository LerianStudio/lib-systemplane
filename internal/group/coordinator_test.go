...
func newCoordinator(t *testing.T) *Coordinator[coordDoc] {
	...
	return NewCoordinator[coordDoc](nil, false, Decode[coordDoc], nil)
}
...
func TestCoordinatorPanicUnderTheStateMutexDoesNotWedgeTheGroup(t *testing.T) {
	t.Run("publish", func(t *testing.T) {
		c := NewCoordinator[coordDoc](nil, false, constantDecode, seedOf(publication("", 1, "seeded")))
	...
	t.Run("register", func(t *testing.T) {
		c := NewCoordinator[coordDoc](nil, false, constantDecode, func() (Publication, bool, error) {
...
func TestCoordinatorDiscardsAPublicationThatDecodedAfterANewerOne(t *testing.T) {
	...
	c := NewCoordinator[coordDoc](nil, false, slowDecode, nil)
	...
	cases := []struct {
	...
	}{
		{
			...
			build: func() *Coordinator[coordDoc] {
				...
				return NewCoordinator[coordDoc](nil, false, decode, seedOf(publication("", 1, "seeded")))
			},
		},
		{
			...
			build: func() *Coordinator[coordDoc] {
				...
				return NewCoordinator[coordDoc](nil, false, constantDecode, seed)
			},
		},
	}
